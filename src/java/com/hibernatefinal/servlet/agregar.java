 ...
 */
package com.hibernatefinal.servlet;
...
public class agregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            request.getRequestDispatcher("/WEB-INF/jsp/agregar.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            Person person = new Person(name,phone,address, Integer.parseInt(age));
            PersonService personService=new PersonServiceImpl();
            personService.agregarPersona(person);
